...
<head>
	...
	<title><?php echo htmlspecialchars((isset($seoTitle) && $seoTitle !== "") ? $seoTitle : "Donate"); ?></title>
	<base href="{{base_url}}" />
	<?php echo isset($sitemapUrls) ? (generateCanonicalUrl($sitemapUrls)."\n") : ""; ?>	
		...
		<link rel="alternate" hreflang="x-default" href="{{base_url}}{{lang_en}}" />
			<link rel="alternate" hreflang="sw" href="{{base_url}}{{lang_sw}}" />
					...
					<meta name="description" content="<?php echo htmlspecialchars((isset($seoDescription) && $seoDescription !== "") ? $seoDescription : "Donate"); ?>" />
			<meta name="keywords" content="<?php echo htmlspecialchars((isset($seoKeywords) && $seoKeywords !== "") ? $seoKeywords : "Donate"); ?>" />
			
	<!-- Facebook Open Graph -->
		<meta property="og:title" content="<?php echo htmlspecialchars((isset($seoTitle) && $seoTitle !== "") ? $seoTitle : "Donate"); ?>" />
			<meta property="og:description" content="<?php echo htmlspecialchars((isset($seoDescription) && $seoDescription !== "") ? $seoDescription : "Donate"); ?>" />
	...
	<link href="css/a1987b9f84e2009fae9fb77f3f909e24-bundle.css?ts=20260802185857" rel="stylesheet" type="text/css" id="wb-page-stylesheet" />
...
<body class="site site-lang-en<?php if (isset($wbPopupMode) && $wbPopupMode) echo ' popup-mode'; ?> " <?php ?>><div id="wb_root" class="root wb-layout-vertical"><div class="wb_sbg"></div><div id="wb_header_a1987b9f84e2009fae9fb77f3f909e24" class="wb_element wb-layout-element" data-plugin="LayoutElement"><div class="wb_content wb-layout-vertical"><div id="a188dd9ebc3858a7a4bf4599d6087d14" class="wb_element wb-layout-element" data-plugin="LayoutElement"><div class="wb_content wb-layout-vertical"><div id="a188dd9ebc38596f36338d0b0d66657b" class="wb_element wb-layout-element" data-plugin="LayoutElement"><div class="wb_content wb-layout-horizontal"><div id="a1986657436700dbe63ba0cbad5bbe2c" class="wb_element wb-layout-element" data-plugin="LayoutElement"><div class="wb_content wb-layout-vertical"><div id="a19fb4223ec700f33f6a6750b25b7549" class="wb_element wb-layout-element" data-plugin="LayoutElement"><div class="wb_content wb-layout-vertical"><div id="a19fc26ad9c300737c8a0c139e48b498" class="wb_element wb-layout-element" data-plugin="LayoutElement"><div class="wb_content wb-layout-vertical"><div id="a188dd9ebc385abbb04767f5aaa74a38" class="wb_element wb_element_picture" data-plugin="Picture" title=""><div class="wb_picture_wrap"><div class="wb-picture-wrapper"><img loading="lazy" alt="" src="gallery_gen/63a123b911049cc657f1d0f2a9cc7765_fit.png?ts=1785686353"></div></div></div><div id="a19fb4297212030bdabc97de04dae2a0" class="wb_element wb_text_element" data-plugin="TextArea" style=" line-height: normal;"><h2 class="wb-stl-custom49">JULIUS KAMBARAGE NYERERE INTERNATIONAL FESTIVAL</h2>
...
<div class="wb_pswp" tabindex="-1" role="dialog" aria-hidden="true">
	...
	<script src="js/a1987b9f84e2009fae9fb77f3f909e24-bundle.js?ts=20260802185857" type="text/javascript" defer></script>{{hr_out}}<script>
    document.addEventListener('DOMContentLoaded', function () {
...
<head>
	...
	window._spDefer = {
		...
		(function(d) {
			...
			<meta http-equiv="content-type" content="text/html; charset=utf-8" />
	<title><?php echo htmlspecialchars((isset($seoTitle) && $seoTitle !== "") ? $seoTitle : "Changia"); ?></title>
	<base href="{{base_url}}" />
	<?php echo isset($sitemapUrls) ? (generateCanonicalUrl($sitemapUrls)."\n") : ""; ?>	
		<link rel="alternate" hreflang="en" href="{{base_url}}{{lang_en}}" />
		<link rel="alternate" hreflang="x-default" href="{{base_url}}{{lang_en}}" />
			<link rel="alternate" hreflang="sw" href="{{base_url}}{{lang_sw}}" />
						...
						<meta name="viewport" content="width=device-width, initial-scale=1" />
					<meta name="description" content="<?php echo htmlspecialchars((isset($seoDescription) && $seoDescription !== "") ? $seoDescription : "Changia"); ?>" />
			<meta name="keywords" content="<?php echo htmlspecialchars((isset($seoKeywords) && $seoKeywords !== "") ? $seoKeywords : "Changia"); ?>" />
			
	<!-- Facebook Open Graph -->
		<meta property="og:title" content="<?php echo htmlspecialchars((isset($seoTitle) && $seoTitle !== "") ? $seoTitle : "Changia"); ?>" />
			<meta property="og:description" content="<?php echo htmlspecialchars((isset($seoDescription) && $seoDescription !== "") ? $seoDescription : "Changia"); ?>" />
			<meta property="og:image" content="<?php echo htmlspecialchars((isset($seoImage) && $seoImage !== "") ? "{{base_url}}".$seoImage : ""); ?>" />
			<meta property="og:type" content="article" />
			<meta property="og:url" content="__wb_curr_url__" />
		<!-- Facebook Open Graph end -->
...
<script>window._spDefer.add(function() {
	(function () {
		...
		</script></div></div></div></div></div><div id="a19fb429722400fb62f16c17777e0dbd" class="wb_element wb-layout-element" data-plugin="LayoutElement"><div class="wb_content wb-layout-horizontal"><div id="a19fb42971f400a1d073d65740953b98" class="wb_element" data-plugin="Button"><a class="wb_button" href="sw/Jisajiri/"><span>Jisajiri Kushiriki</span></a></div><div id="a19fb429722c00d2df553faa4f96bb89" class="wb_element" data-plugin="Button"><a class="wb_button" href="sw/Bidhaa-za-Tamasha/"><span>Bidhaa</span></a></div><div id="a19fb4297209006e0ba9445e1db2f558" class="wb_element" data-plugin="Button"><a class="wb_button" href="sw/Waliopendekezwa-kupewa-Tuzo/"><span>Walio pendekezwa Kupata Tuzo</span></a></div></div></div></div></div><div id="a19fb81fa1120059e7c1682d66b9ba06" class="wb_element wb-layout-element" data-plugin="LayoutElement"><div class="wb_content wb-layout-vertical"></div></div></div></div></div></div></div></div><div id="wb_main_a1987b9f84e2009fae9fb77f3f909e24" class="wb_element wb-layout-element" data-plugin="LayoutElement"><div class="wb_content wb-layout-vertical"><div id="a1987b9f8ad8045605912a0f66bea21d" class="wb_element wb-layout-element" data-plugin="LayoutElement"><div class="wb_content wb-layout-horizontal"><div id="a1987b9f8ad805a83182f66bab4a5480" class="wb_element wb-layout-element" data-plugin="LayoutElement"><div class="wb_content wb-layout-horizontal"></div></div></div></div><div id="a19faaa1444f002f65ce21f45b529ffb" class="wb_element wb_text_element" data-plugin="TextArea" style=" line-height: normal;"><h1 class="wb-stl-custom50">DONATIONS</h1>
</div><div id="a19faaa17bd600adf6fb78d47f862f10" class="wb_element wb_text_element" data-plugin="TextArea" style=" line-height: normal;"><p style="margin: 0in 0in 8pt; text-align: center;"><span class="wb-stl-custom8"><span style="font-size:11pt"><span style="line-height:normal"><span style="font-family:Calibri,sans-serif"><b><span style="font-size:24.0pt"><span style='font-family:"Times New Roman",serif'>WHY YOUR DONATION MATTERS</span></span></b></span></span></span></span></p>
...
<h3 class="wb-stl-custom16" style="text-align: center;">WEBSITE: www.jukanye.com</h3>
</div><div id="a188dd9ebc38721835f60daecdc81bab" class="wb_element wb_element_picture" data-plugin="Picture" title=""><div class="wb_picture_wrap"><div class="wb-picture-wrapper"><img loading="lazy" alt="" src="gallery_gen/3a0fa4358ae2f4fb06a94eaab03b4403_fit.png?ts=1785686353"></div></div></div><div id="a188dd9ebc387353ef2d51652b5ef64e" class="wb_element wb_text_element" data-plugin="TextArea" style=" line-height: normal;"><p class="wb-stl-footer">© 2025 <a href="http://jukanye.com">jukanye.com</a> - Kuwaenzi Viongozi wa Afrika Walioongoza Harakati za Ukombozi</p>
</div></div></div></div></div><div id="wb_footer_c" class="wb_element" data-plugin="WB_Footer" style="text-align: center; width: 100%;"><div class="wb_footer"></div><script>window._spDefer.add(function() {
			$(function() {
				var footer = $(".wb_footer");
				var html = (footer.html() + "").replace(/^\s+|\s+$/g, "");
